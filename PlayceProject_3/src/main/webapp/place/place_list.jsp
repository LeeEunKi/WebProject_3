...
<div class="section section-properties">
	  <div class="container">
		  <div class="col-lg-6">
		     <h2 class="font-weight-bold text-primary heading">${type } 카테고리</h2>
		     <span class="sub-title">검색된 <span style="color:#132F66; font-weight:bold;">${totalCount }</span>개의 장소</span><br/>
		  </div>
